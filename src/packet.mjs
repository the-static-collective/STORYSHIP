...
export function sealTransferPacket({replay,packet_label}){
  ...
  const body={
    ...
    voyage_id:replay.voyage_id,
    event_cut:replay.event_cut,
    constitution_id:replay.constitution_id,
    replay_id:replay.replay_id,
    reality_projection_id:replay.projections.reality.projection_id,
    memory:{manifest_projection_id:replay.projections.manifest.projection_id,narrative_relation_ids},
    open_berth,
    branch_heads:replay.projections.branch_heads.value,
    source_cut_ids:replay.source_cut_ids,
    packet_label,
  };
